...
public class AsciiPanel extends JPanel {
    ...
    private BufferedImage[] brosImg = new BufferedImage[8];
    private BufferedImage[] monsImg = new BufferedImage[7];
    ...
    private void loadGlyphs() {
        try {
            //URL url = new URL("resources/cp437_9x16.png");
            //glyphSprite = ImageIO.read(url);
            glyphSprite = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(terminalFontFile));
            floorImg = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.FLOOR.getFontFilename()));
            brosImg[0] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO1.getFontFilename()));
            brosImg[1] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO2.getFontFilename()));
            brosImg[2] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO3.getFontFilename()));
            brosImg[3] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO4.getFontFilename()));
            brosImg[4] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO5.getFontFilename()));
            brosImg[5] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO6.getFontFilename()));
            brosImg[6] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO7.getFontFilename()));
            brosImg[7] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.BRO8.getFontFilename()));
            monsImg[0] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON1.getFontFilename()));
            monsImg[1] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON2.getFontFilename()));
            monsImg[2] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON3.getFontFilename()));
            monsImg[3] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON4.getFontFilename()));
            monsImg[4] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON5.getFontFilename()));
            monsImg[5] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON6.getFontFilename()));
            monsImg[6] = ImageIO.read(AsciiPanel.class.getClassLoader().getResource(AsciiFont.MON7.getFontFilename()));
        ...
        //glyphs[250] = new BufferedImage(charWidth, charHeight, BufferedImage.TYPE_INT_ARGB);
        glyphs[250].getGraphics().drawImage(floorImg, 0, 0, charWidth, charHeight, 0, 0, charWidth,
                    charHeight, null);
        
        for(int i = 0; i < 8; ++i) {
            glyphs[200+i].getGraphics().drawImage(brosImg[i], 0, 0, charWidth, charHeight, 0, 0, charWidth,
                    charHeight, null);
        }

        for(int i = 0; i < 7; ++i) {
            glyphs[210+i].getGraphics().drawImage(monsImg[i], 0, 0, charWidth, charHeight, 0, 0, charWidth,
                    charHeight, null);
        }
